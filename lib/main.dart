...
Future<void> _firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  ...
  if (message.data['notification_type'] == 'incoming_call') {
    ...
    if (DateTime.now()
      ...
      String? strCallArg = SharedPref.instance.shared.getString('notifications_callArg');
      if(strCallArg.validate().isEmpty) {
        ...
        SharedPref.instance.shared.setString('notifications_callArg', jsonEncode(callArg));
